          ...
          <b-row>
            <b-col md="12" class="mb-2">
              ...
              <b-form-input
                ...
                name="email"
                id="email"
                v-bind:value="(datas.email !== undefined) ? datas.email:''"
              ></b-form-input>
            </b-col>
            <b-col md="6" class="mb-2">
              ...
              <b-form-input
                ...
                name="fname"
                id="fname"
                v-bind:value="(datas.firstname !== undefined) ? datas.firstname:''"
              ></b-form-input>
            </b-col>
            <b-col md="6" class="mb-2">
              ...
              <b-form-input
                ...
                name="lname"
                id="lname"
                v-bind:value="(datas.lastname !== undefined) ? datas.lastname:''"
              ></b-form-input>
            </b-col>
            <b-col md="12" class="mb-2">
              ...
              <b-form-input
                ...
                id="position"
                name="position"
                v-bind:value="(datas.position !== undefined) ? datas.position:''"
              ></b-form-input>
            </b-col>
            <b-col md="12" class="mb-2">
              ...
              <b-form-input
                ...
                id="phone"
                name="phone"
                v-bind:value="(datas.phone !== undefined) ? datas.phone:''"
              ></b-form-input>
            </b-col>
            <b-col md="12">
...
export default {
  ...
  methods: {
    getData() {
      this.$http
        .get(this.base_api + `/admin/users/${this.$route.params.email}`, {
          headers: {
    ...
    submitData() {
      let api = this.base_api + "/admin/technicians";
      this.$http
        .put(
          api,
          {
        ...
        .then(res => {
          ...
          if (res.status === 200) {
            ...
            this.$router.push(`/ManageTechnician`);
          }
        });
    }
  }
